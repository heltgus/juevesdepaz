...
$config['tables']['groups']          = 'perfiles';
$config['tables']['users_groups']    = 'usuario_perfil';
...
$config['identity']                   = 'usuario';             // A database column which is used to login with
